...
꿈 속 주요 장면과 핵심 요소
꿈 속 주요 장면별 상징적 요소 분석
이 꿈이 말해줄 수 있는 주제
현실에서 점검해 볼 질문
마음과 상황을 돌아 보는 간단한 처방
종합 정리
...
편안하고 친근한 어조로, 꿈 해몽 전문가가 친구에게 이야기하듯 자연스럽게 해석해 주세요.`;
      ...
      const response = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "너는 경험이 풍부한 꿈해몽 전문가야. 꿈속의 주요장면과 의미를 깊이 있게 분석하되 최대한 한국의 전통적인 꿈해석을 기준으로 해석하고 상징적, 심리적인 관점에서 해석합니다. 편안하고 자연스러운 어조로 대화하며, 각 해석은 상세하고 개인적이며, 실생활에 도움이 되는 조언을 포함해야 합니다."
          },
          {
            role: "user",
            content: prompt
